            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {patientLinks.map((item) => (
                <Link
                  key={item.label}
                  href={item.href}
                  className="bg-white border border-slate-200 rounded-2xl p-6 group hover:-translate-y-1 hover:border-teal-200 hover:shadow-hover-teal transition-all duration-200"
                >
